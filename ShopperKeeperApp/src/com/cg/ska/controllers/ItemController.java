...
public class ItemController {
	...
	public ModelAndView showList(){
		return new ModelAndView("list","items",itemService.getAllItems());
	}
	
	@RequestMapping(value="/new",method=RequestMethod.GET)
	public ModelAndView showNew(){
		return new ModelAndView("new","item",new Item());
	}
	...
	public ModelAndView showEdit(@RequestParam int itemCode){
		return new ModelAndView("edit","item",itemService.getItmeByCode(itemCode));
	}
